...
function genbuttons(){
   buttons = `
    ...
    <button style="width: 16vh; height: 8vh;" onclick="battlemanager(${player1.pokemon[0].move1})">${moves[player1.pokemon[0].move1].name}</button>
    <button style="width: 16vh; height: 8vh;" onclick="battlemanager(${player1.pokemon[0].move2})">${moves[player1.pokemon[0].move2].name}</button>
    <button style="width: 16vh; height: 8vh;" onclick="battlemanager(${player1.pokemon[0].move3})">${moves[player1.pokemon[0].move3].name}</button>
    <button style="width: 16vh; height: 8vh;" onclick="battlemanager(${player1.pokemon[0].move4})">${moves[player1.pokemon[0].move4].name}</button>
    </div>
    `
    return buttons
}
